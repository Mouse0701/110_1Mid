...
namespace _110_1Mid {
        ...
        {
            String[,] la_ZoneCode = new String[2, 3] { { "0911", "0921", "0960" }, { "02", "04", "07" } };
            String[] la_City1 = new String[6] { "台北市", "新北市", "台中市", "台中縣", "高雄市", "高雄縣" };
            String[,] la_City2 = new String[3, 2] { {"台北市","新北市" },
                                                {"台中市","台中縣" },
                                                {"高雄市","高雄縣" } };
            protected void Page_Load(object sender, EventArgs e)
            {
                if (IsPostBack == false)
                {
                    ...
                    for (int i = 0; i <= 2; i++)
                    {
                        o_li = new ListItem(la_ZoneCode[0, i]);
                        ddl_ZoneCode.Items.Add(o_li);
                    }
                    for (int i = 0; i <= 5; i++)
                    {
                        o_li = new ListItem(la_City1[i]);
            ...
            protected void ddl_Type_SelectedIndexChanged(object sender, EventArgs e)
            {
                ...
                else
                {
                    for (int i = 0; i <= 2; i++)
                    {
                        o_li = new ListItem(la_ZoneCode[1, i]);
                        ddl_ZoneCode.Items.Add(o_li);
                    }
                    for (int i = 0; i <= 1; i++)
                    {
                        o_li = new ListItem(la_City2[0, i]);
                        ddl_City.Items.Add(o_li);
                    }
                }
            }
            ...
            protected void ddl_ZoneCode_SelectedIndexChanged(object sender, EventArgs e)
            {
                ...
                else if (ddl_ZoneCode.SelectedValue == "04")
                {
                    for (int i = 0; i <= 1; i++)
                    {
                        o_li = new ListItem(la_City2[1, i]);
                        ddl_City.Items.Add(o_li);
                    }
                }
                else if (ddl_ZoneCode.SelectedValue == "07")
                {
                    for (int i = 0; i <= 1; i++)
                    {
                        o_li = new ListItem(la_City2[2, i]);
                        ddl_City.Items.Add(o_li);
                    }
                }
                else
